package com.liujun.auto.generator.builder.ddd.custom.view.generatecode;
...
import com.liujun.auto.generator.builder.ddd.entity.JavaAnnotationList;
...
import com.liujun.auto.generator.builder.ddd.custom.view.constant.ImportCodeActionViewPackageKey;
import com.liujun.auto.generator.builder.ddd.custom.view.constant.JavaMethodViewName;
...
public class GenerateJavaViewAction {
  ...
  private boolean checkOutPage(DataParam param) {
    ...
    for (MethodInfo methodItem : methodList) {
      if (MethodOperatorEnum.QUERY_PAGE.getType().equals(methodItem.getOperator())) {
        return true;
      }
    }
