package com.liujun.auto.generator.builder.operator.ddd.full.other;
...
import com.liujun.auto.generator.builder.operator.utils.JavaEncodeUtils;
...
public class JavaCodeResourceI18nZhCnCreate implements GenerateCodeInf {
  ...
  /** 超长长度的提示 */
  private static final String MAX_TITLE = "超过最大长度 (#maxLength#)";

  public static final JavaCodeResourceI18nZhCnCreate INSTANCE =
      new JavaCodeResourceI18nZhCnCreate();
