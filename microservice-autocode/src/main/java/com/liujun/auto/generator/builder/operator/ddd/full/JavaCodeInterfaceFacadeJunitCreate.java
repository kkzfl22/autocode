...
import com.liujun.auto.generator.builder.operator.ddd.code.GenerateJavaFacadeJunitApi;
...
public class JavaCodeInterfaceFacadeJunitCreate implements GenerateCodeInf {
  ...
  public static final JavaCodeInterfaceFacadeJunitCreate INSTANCE =
      new JavaCodeInterfaceFacadeJunitCreate();
   ...
   * @return 集合
   */
  private List<ImportPackageInfo> getRunImport(
      Map<String, Map<String, ImportPackageInfo>> packageMap, String tableName) {
    // 存储层实体
