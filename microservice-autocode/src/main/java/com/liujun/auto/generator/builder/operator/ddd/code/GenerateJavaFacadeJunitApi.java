package com.liujun.auto.generator.builder.operator.ddd.code;
...
import com.liujun.auto.generator.builder.operator.code.junit.GenerateJunitQuery;
import com.liujun.auto.generator.builder.operator.code.junit.GenerateJunitUpdate;
...
public class GenerateJavaFacadeJunitApi {
  ...
  private void invokePageQueryMethod(
    ...
    sb.append(Symbol.ANGLE_BRACKETS_LEFT)
        ...
        .append(Symbol.ANGLE_BRACKETS_RIGHT);
    sb.append(Symbol.SPACE)
        .append(ImportCodePackageKey.API_PAGE_RESPONSE.getPackageInfo().getVarName());
    sb.append(Symbol.SPACE);
    sb.append(Symbol.EQUAL).append(Symbol.SPACE);
    sb.append(Symbol.BRACKET_LEFT);
    sb.append(ImportCodePackageKey.API_PAGE_RESPONSE.getPackageInfo().getClassName());
