...
public class GenerateJavaDomainServiceInvoke {
  ...
  public StringBuilder generateDomainService(
    ...
    for (MethodInfo methodItem : methodList) {
      ...
      // 如果当前为查询分页操作
        ...
        this.pageQueryMethod(sb, methodItem, domainPackageInfo, JavaVarName.REPOSITORY_INSTANCE_NAME);
      }
      // 如果当前为查询则进行查询调用操作
  ...
  private void pageMethodBuilder(
    ...
    // 泛型类型
    String genericClass = JavaCommentUtil.pageQueryReturn(classType);
