...
public class JavaVarName {
  ...
  /** 数据库实例的名称 */
  public static final String SPRING_INSTANCE_NAME = "mapper";

  /** 存储层的实例对象 */
  public static final String REPOSITORY_INSTANCE_NAME = "repository";

  /** domain的实例对象 */
  public static final String DOMAIN_INSTANCE_NAME = "domainService";

  /** 应用服务 */
  public static final String APPLICATION_INSTANCE_NAME = "applicationService";

  /** 接口层的实例的名称 */
  public static final String FACADE_INSTANCE_NAME = "facadeService";
  ...
  /** 单元测试的事务配制的数据源名称 */
  public static final String JUNIT_TRANSACTION_MANAGER_NAME = "testTransactionManager";

  /** 单元测试事务的配制文件名 */
  public static final String JUNIT_TRANSACTION_CLASS_NAME = "MyBatisScanConfiguration";
