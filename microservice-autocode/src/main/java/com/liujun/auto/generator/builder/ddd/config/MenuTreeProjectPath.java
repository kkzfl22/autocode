...
public class MenuTreeProjectPath {
     ...
     * @return 模块名称
     */
    public DirNode getRepositoryMybatisMapperNode() {
     ...
     * @return 模块名称
     */
    public DirNode getTestJavaNode() {
        return projectMenuTree
                .getRoot()
                .getChildren(ProjectMenuTreeKey.SRC.getKey())
   ...
   * @return 模块名称
   */
  public DirNode getTestResourceNode() {
    return projectMenuTree
            .getRoot()
            .getChildren(ProjectMenuTreeKey.SRC.getKey())
            .getChildren(ProjectMenuTreeKey.SRC_TEST.getKey())
     ...
     * @return 模块名称
     */
    public DirNode getResourceNode() {
        return projectMenuTree
                .getRoot()
                .getChildren(ProjectMenuTreeKey.SRC.getKey())
                .getChildren(ProjectMenuTreeKey.SRC_MAIN.getKey())
