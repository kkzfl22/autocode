package com.liujun.micro.autocode.generator.builder.operator.ddd.custom.def.facade;
...
import com.liujun.micro.autocode.generator.builder.constant.ImportCodeActionDefaultPackageKey;
...
public class GenerateJavaAction {
  ...
  private static final List<String> IMPORT_PKG =
      Arrays.asList(
          ...
          ImportCodeActionDefaultPackageKey.API_RESPONSE.getPackageInfo().packageOut(),
          ...
          ImportCodeActionDefaultPackageKey.API_ASSEMBLER_PAGE.getPackageInfo().packageOut(),
          ImportCodeActionDefaultPackageKey.API_DATA_RESPONSE.getPackageInfo().packageOut());
  ...
  public StringBuilder generateAction(DataParam param) {
    ...
    // 类的声明
    StringBuilder sb = GenerateJavaAction.INSTANCE.actionServiceDefine(param);
  ...
  public String updateMethod(DataParam param, MethodInfo method, String httpMethodName) {
    ...
    JavaMethodEntity methodEntity =
        JavaMethodEntity.builder()
            ...
            // 返回值
            .type(ImportCodeActionDefaultPackageKey.API_RESPONSE.getPackageInfo().getClassName())
            // 返回注释
            .returnComment(
                ImportCodeActionDefaultPackageKey.API_RESPONSE.getPackageInfo().getClassComment())
            // 方法名
            .name(method.getName())
            // 批量操作参数
  ...
  private String invokeData(MethodInfo method, DataParam param) {
    ...
    sb.append(Symbol.SPACE).append(application.getVarName());
  ...
  public String pageQueryMethod(DataParam param, MethodInfo method) {
    ...
    List<JavaMethodArguments> argumentsList =
        Arrays.asList(
            JavaMethodArguments.builder()
                .type(
                    ImportCodeActionDefaultPackageKey.API_PAGE_REQUEST
                            .getPackageInfo()
                            .getClassName()
                        + Symbol.ANGLE_BRACKETS_LEFT
                        + param.getPkg(GenerateCodePackageKey.INTERFACE_OBJECT).getClassName()
