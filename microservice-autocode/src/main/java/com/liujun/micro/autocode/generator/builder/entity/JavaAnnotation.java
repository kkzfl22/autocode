...
public class JavaAnnotation {
    ...
    public static class Builder {
         ...
         * @return
         */
        public JavaAnnotation.Builder annotationValue(boolean notOutChar, String key) {
            if (null == annotationValue) {
                annotationValue = new ArrayList<>();
            }
    ...
    private String getAnnotationValue(List<AnnotationValueElement> value) {
        ...
        for (AnnotationValueElement valueElement : value) {
            ...
            //当键与值都不为空时，才输出等号
            if (StringUtils.isNotEmpty(valueElement.getKey()) && StringUtils.isNotEmpty(valueElement.getValue())) {
