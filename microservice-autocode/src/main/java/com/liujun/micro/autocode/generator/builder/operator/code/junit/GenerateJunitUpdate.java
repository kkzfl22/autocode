...
public class GenerateJunitUpdate {
    ...
    public void batchInsertMethod(
        ...
        this.batchInsertMethod(sb, method, methodList, insertReturnType, insertSuccessValue, Symbol.EMPTY);
    }
    ...
    public void batchInsertMethod(
        ...
        // 调用批量插入方法
        sb.append(this.invokeBatchInsert(methodList, insertReturnType, insertSuccessValue, getMethod));
    ...
    private String invokeBatchInsert(
            List<MethodInfo> methodList, String insertReturnType, String insertSuccessValue, String dataGetMethod) {

        StringBuilder sb = new StringBuilder();

        // 调用批量添加方法
        sb.append(this.invokeBatch(methodList, insertReturnType, insertSuccessValue, dataGetMethod));
    ...
    public void oneInsertMethod(
        ...
        this.oneInsertMethod(sb, method, insertReturnType, insertSuccessValue, Symbol.EMPTY);
    }
     ...
     */
    public void oneInsertMethod(
            StringBuilder sb, MethodInfo method, String insertReturnType, String insertSuccessValue, String getMethod) {
        String methodName = NameProcess.INSTANCE.toJavaNameFirstUpper(method.getName());
        ...
        // 调用添加方法
        sb.append(insertInvokeMethod(method, insertReturnType, insertSuccessValue, getMethod));
    ...
    public String invokeBatch(
        ...
        return this.invokeBatch(methodList, insertReturnType, insertSuccessValue, Symbol.EMPTY);
    }
    ...
    public String invokeBatch(
        ...
        // 优先使用批量添加方法
        if (batchInsert != null) {
            return invokeBatchMethod(insertReturnType, insertSuccessValue, batchInsert, dataGetMethod);
        }
    ...
    private String invokeBatchMethod(
            String insertReturnType, String insertSuccessValue, MethodInfo batchInsert, String methodRsp) {
        StringBuilder sb = new StringBuilder();
        int tabIndex = 1;
    ...
    public String insertInvokeMethod(
        ...
        return this.insertInvokeMethod(method, insertReturnType, insertSuccessValue, Symbol.EMPTY);
    }
     ...
     */
    public String insertInvokeMethod(
            MethodInfo method, String insertReturnType, String insertSuccessValue, String getMethod) {
        StringBuilder sb = new StringBuilder();
        ;
        int tabIndex = 0;
    ...
    public void oneUpdateMethod(
            ...
            String insertReturnType,
            String insertSuccessValue) {
        this.oneUpdateMethod(sb, updateMethod, insertMethod, insertReturnType, insertSuccessValue, Symbol.EMPTY);
    }
    ...
    public void oneUpdateMethod(
        ...
        // 调用添加方法
        sb.append(this.insertInvokeMethod(insertMethod, insertReturnType, insertSuccessValue, getMethod));
    ...
    public void deleteMethod(
            ...
            String insertReturnType,
            String insertSuccessValue) {
        this.deleteMethod(sb, deleteMethod, poPackage, insertReturnType, insertSuccessValue, Symbol.EMPTY);
    }
    ...
    public void deleteMethod(
        ...
        // 检查并执行单个清理操作
        junitDeleteOne(sb, tabIndex, deleteMethod, insertReturnType, insertSuccessValue, getMethod);

        // 检查并执行批量删除操作
        junitBatchDelete(sb, tabIndex, deleteMethod, poPackage, insertReturnType, insertSuccessValue, getMethod);
    ...
    public void batchDelete(
            ...
            String insertReturnType,
            String insertSuccessValue) {
        this.batchDelete(sb, queryMethod, poPackageInfo, columnMap, methodList, dbType, primaryList, insertReturnType, insertSuccessValue, Symbol.EMPTY);
    }
    ...
    public void batchDelete(
        ...
        // 调用批量添加方法
        sb.append(
                GenerateJunitUpdate.INSTANCE.invokeBatch(methodList, insertReturnType, insertSuccessValue, getMethod));
