package com.liujun.micro.autocode.generator.builder.operator.ddd.full.repositorymyatbisplus;

import com.liujun.micro.autocode.constant.Symbol;
import com.liujun.micro.autocode.generator.builder.constant.GenerateCodePackageKey;
import com.liujun.micro.autocode.generator.builder.constant.GenerateCommConstant;
 ...
 */
public class JavaCodeRepositoryJunitScanCfgCreate implements GenerateCodeInf {
  ...
  public static final JavaCodeRepositoryJunitScanCfgCreate INSTANCE =
      new JavaCodeRepositoryJunitScanCfgCreate();
  ...
  public void mybatisDependency(GenerateCodeContext param) {
    ...
    ImportPackageInfo importPkg =
        PkgBuildMethod.classInfoComment(
            param.getJavaCodePackage().getRepositoryDaoNodeConfig().outJavaPackage(),
            JavaVarName.JUNIT_TRANSACTION_CLASS_NAME,
            JavaCodeRepositoryJunitScanCfgCreate.INSTANCE.getClassComment());
