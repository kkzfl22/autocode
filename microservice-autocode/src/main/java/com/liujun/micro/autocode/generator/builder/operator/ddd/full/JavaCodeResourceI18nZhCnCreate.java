...
public class JavaCodeResourceI18nZhCnCreate implements GenerateCodeInf {
    ...
    public static final JavaCodeResourceI18nZhCnCreate INSTANCE = new JavaCodeResourceI18nZhCnCreate();
    ...
    public void generateCode(GenerateCodeContext param) {
        ...
        // 需要执行文件清理，再生成
        GenerateOutFileUtils.cleanFile(param.getFileBasePath(), resourceI18nPath, RESOURCE_CHINA_NAME);
