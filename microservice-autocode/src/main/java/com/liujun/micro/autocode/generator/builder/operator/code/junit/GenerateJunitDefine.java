...
public class GenerateJunitDefine {
    ...
    public StringBuilder defineHead(
            ...
            String author) {
        return defineHead(poPackage, junitPackage, methodList, dependencyClass, mybatisScanConfig, importAnnotationPkgList, Collections.emptyList(), author);
    }
    ...
    public StringBuilder defineHead(
        ...
        JavaClassEntity classEntityInfo =
                JavaClassEntity.builder()
                        ...
                        // 导入包信息
                        .importList(getImportList(poPackage, methodList, mybatisScanConfig, importAnnotationPkgList, importPkgList))
                        // 作者
                        .author(author)
                        //加入注解
     ...
     * @return
     */
    private List<String> getImportList(ImportPackageInfo poPackage,
                                       List<MethodInfo> methodList,
                                       ImportPackageInfo mybatisScanConfig,
                                       List<ImportPackageInfo> importAnnotationPkgList,
     ...
     * @return
     */
    private List<String> junitClassAnnotation(List<String> dependencyClass, List<ImportPackageInfo> importPkgList) {
        List<String> annotationList = new ArrayList<>();

        //@RunWith(SpringRunner.class)
        String runWithAnnotation = JavaAnnotation.builder()
                .annotation(ImportJunitPkgKey.SPRING_RUNNER.getPackageInfo().getAnnotation())
                .annotationValue(true, ImportJunitPkgKey.SPRING_RUNNER.getPackageInfo().getClassName() + ANNOTATION_VALUE_SUFFIX)
                .build()
                .outAnnotation();
        ...
        String springBootTestAnnotation = JavaAnnotation.builder()
        ...
        String transactionalTestAnnotation = JavaAnnotation.builder()
                .annotation(ImportJunitPkgKey.SPRING_BOOT_TEST_TRANSACTIONAL.getPackageInfo().getAnnotation())
                .annotationValue(SPRING_BOOT_TEST_TRANSACTIONAL_MANAGER,
                        JavaVarName.JUNIT_TRANSACTION_MANAGER_NAME)
                .build()
                .outAnnotation();
        ...
        if (null != importPkgList && !importPkgList.isEmpty()) {
            String importAnnotation = JavaAnnotation.builder()
                    .annotation(ImportJunitPkgKey.SPRING_BOOT_TEST_IMPORT.getPackageInfo().getAnnotation())
        ...
        //注解加载测试文件
        String configFileTestAnnotation = JavaAnnotation.builder()
                .annotation(ImportJunitPkgKey.SPRING_BOOT_TEST_PROPERTY_SOURCE.getPackageInfo().getAnnotation())
