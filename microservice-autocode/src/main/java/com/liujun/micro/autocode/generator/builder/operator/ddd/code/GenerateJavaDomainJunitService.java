    ...
    public StringBuilder generateJunitService(
        ...
        StringBuilder sb =
                GenerateJunitDefine.INSTANCE.defineHead(
                        entityPackage, junitPackage, methodList, dependencyList, mybatisScanConfig, importCfgList, author);
        ...
        for (MethodInfo methodItem : methodList) {
            ...
            // 修改方法
                ...
                GenerateJunitUpdate.INSTANCE.oneUpdateMethod(
                        sb, methodItem, insertMethod, JavaKeyWord.TYPE_BOOLEAN, Boolean.TRUE.toString());
            }
            // 非主键的删除方法
    ...
    public void insertMethod(StringBuilder sb, MethodInfo method, List<MethodInfo> methodList) {
        ...
        if (batchFlag) {
            ...
            GenerateJunitUpdate.INSTANCE.batchInsertMethod(
                    sb, method, methodList, JavaKeyWord.TYPE_BOOLEAN, Boolean.TRUE.toString());
        } else {
            // 执行单个添加
            GenerateJunitUpdate.INSTANCE.oneInsertMethod(
                    sb, method, JavaKeyWord.TYPE_BOOLEAN, Boolean.TRUE.toString());
        }
    }
        ...
        if (GenerateJunitQuery.INSTANCE.batchFlag(queryMethod)) {
            ...
            sb.append(
                    GenerateJunitUpdate.INSTANCE.invokeBatch(
                            methodList, JavaKeyWord.TYPE_BOOLEAN, Boolean.TRUE.toString()));
        ...
        // 再执行单个添加操作
            ...
            sb.append(
                    GenerateJunitUpdate.INSTANCE.insertInvokeMethod(
                            insertMethod, JavaKeyWord.TYPE_BOOLEAN, Boolean.TRUE.toString()));
