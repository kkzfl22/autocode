package com.liujun.micro.autocode.algorithm.booyermoore;
...
public class CharMatcherBmBadChars {
  ...
  private char getIgnoreCase(char mainChar) {
    ...
    if (charindex >= CharConfig.UPPER_CASE_START && charindex <= CharConfig.UPPER_CASE_END) {
      return (char) (charindex + CharConfig.UPPER_TO_LOWER);
    }
