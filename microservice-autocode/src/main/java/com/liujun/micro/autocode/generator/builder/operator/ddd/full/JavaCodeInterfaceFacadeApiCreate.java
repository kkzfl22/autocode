...
public class JavaCodeInterfaceFacadeApiCreate implements GenerateCodeInf {
    ...
    public static final JavaCodeInterfaceFacadeApiCreate INSTANCE = new JavaCodeInterfaceFacadeApiCreate();
    ...
    public void generateCode(GenerateCodeContext param) {
        ...
        while (tableNameEntry.hasNext()) {
            ...
            // 进行存储层的接口输出
            GenerateOutFileUtils.outJavaFile(sb, GeneratePathUtils.outApiPath(param), javaPackageStr, className);
        }
    }
