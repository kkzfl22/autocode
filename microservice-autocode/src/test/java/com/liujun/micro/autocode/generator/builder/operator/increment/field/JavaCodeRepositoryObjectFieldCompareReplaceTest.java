...
import com.liujun.micro.autocode.generator.builder.operator.ddd.increment.field.JavaCodeRepositoryObjectFieldCompareReplace;
...
import com.liujun.micro.autocode.generator.builder.operator.ddd.increment.field.entity.EntityMethod;
...
public class JavaCodeRepositoryObjectFieldCompareReplaceTest {
  ...
  private Method getMethod(String methodName, Class<?>... paramClass) {
    try {
      Class cls =
          Class.forName(
                  "com.liujun.micro.autocode.generator.builder.operator.ddd.increment.field.JavaCodeRepositoryObjectFieldCompareReplace");
